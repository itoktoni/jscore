...
import RoleFormCreateVueform from '../pages/role/CreateVueform.vue'

// Role route constants
export const ROLE_ROUTES = {
  ROLE_LIST: 'RoleList',
  CREATE_ROLE: 'CreateRole',
  CREATE_ROLE_VUEFORM: 'CreateRoleVueform',
  EDIT_ROLE: 'EditRole'
}
...
export const roleRoutes = [
  ...
  {
    path: '/roles/create-vueform',
    name: ROLE_ROUTES.CREATE_ROLE_VUEFORM,
    component: RoleFormCreateVueform,
    meta: {
      requiresAuth: true, // Only accessible when authenticated
      requiresAdmin: true // Only accessible for admin users
    }
