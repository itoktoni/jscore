...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/users', name: 'UserList', component: { template: '<div>Users</div>' } },
    { path: '/users/table', name: 'UserTable', component: { template: '<div>User Table</div>' } },
    { path: '/users/create', name: 'CreateUser', component: { template: '<div>Create User</div>' } },
    { path: '/users/:id/edit', name: 'EditUser', component: { template: '<div>Edit User</div>' } }
  ]
})
